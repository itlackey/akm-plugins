...
4. After the user completes setup, you may confirm by checking `~/.config/akm/config.json` (or `$XDG_CONFIG_HOME/akm/config.json`) for `agent.default` if they asked whether an agent CLI was configured.
