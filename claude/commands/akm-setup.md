...
4. After the user completes setup, you may confirm by running `akm config get defaults.agent` (the v0.8.0 canonical slot; the legacy `agent.default` shape is auto-migrated on load) if they asked whether an agent CLI was configured.
