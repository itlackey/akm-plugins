...
| Checkpoint + candidates | #57 | Candidates shipped in both plugins; Claude session-checkpoint memory writer removed in 0.8.0 (replaced by `akm extract --type claude-code`) |
