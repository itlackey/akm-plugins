...
OpenCode plugin for [AKM](https://github.com/itlackey/akm) `^0.9.2`. It exposes exactly five public tools and uses lifecycle hooks to bring relevant AKM context into a session.
